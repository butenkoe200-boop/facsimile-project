      ...
      <div className="tp-frame">
        ...
        <div className="px-4 sm:px-6 pb-6 pt-4">
          ...
          <div className="mt-4 rounded-[14px] border border-line bg-card p-5">
            <div className="grid grid-cols-1 sm:grid-cols-[1fr_296px] gap-5 lg:grid-cols-[360px_minmax(0,1fr)] lg:gap-5">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-3 rounded-[14px] border border-line bg-surface-2 p-4">
                  <div className="grid grid-cols-1 sm:grid-cols-[132px_1fr] items-center gap-3 lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-12 lg:px-8">
                    <PhoneMock />
                    <div className="min-w-0">
